...
const contacts = [
  ...
  //   link: 'https://example.com/abdul-rehman',
  // }
];
  ...
  return (
    <div id="contacts" className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div data-aos="fade-up" className="bg-white rounded-lg shadow-lg p-8 mt-8">
          <div className="flex items-center justify-center mb-6">
            <Building2 className="w-8 h-8 text-blue-600 mr-3" />
            <h2 className="text-2xl font-bold text-gray-900">IEEE NUCES Lahore chapter</h2>
          </div>
